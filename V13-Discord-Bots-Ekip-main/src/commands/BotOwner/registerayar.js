...
.addComponents(
  ...
  new Discord.MessageButton()
   ...
   .setDescription(`
**1- Normal teyit (.e @Gökw 16)**
**2- Buttonlu teyit (.isim @Gökw 16 - Button seçim)**
**3- Etiketsiz teyit (.isim @Gökw 16 - .e)**
...
const collector = msg.createMessageComponentCollector({ filter, time: 30000 })
    ...
    collector.on("collect", async (button) => {
      ...
      server.save();
      button.reply("Teyit modu cinsiyet olarak değiştirildi. Artık \`.e @Gökw 16\` ile kayıt yapılabilecek")
        ...
        button.reply("Teyit modu buttonlu olarak değiştirildi. Artık \`.isim @Gökw 16 - Button seçim\` ile kayıt yapılabilecek")
        ...
        button.reply("Teyit modu etiketsiz olarak değiştirildi. Artık \`.isim @Gökw 16 - .e\` ile kayıt yapılabilecek")
